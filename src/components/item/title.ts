...
export class TitleComponent extends BaseContents<HTMLElement> {
  constructor() {
    ...
    const pageTitle = document //
      .querySelector('.page-title')! as HTMLHeadingElement
    const title = this.element //
      .querySelector('.title-input')! as HTMLInputElement
